...
<div id="content" role="main">
    <div class="container">
        <section class="row">
            <a href="#edit-department" class="visually-hidden-focusable" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <section class="row">
            <div id="edit-department" class="col-12 content scaffold-edit" role="main">
                ...
                <g:form resource="${this.department}" controller="${controllerName}" method="PUT">
                    <g:hiddenField name="version" value="${this.department?.version}" />
                    <fieldset class="form">
                        <f:field bean="department" property="name" class="form-control mb-3" required="true" />
                        <f:field bean="department" property="code" class="form-control mb-3" required="true" />
                    </fieldset>
