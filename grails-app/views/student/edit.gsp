        ...
        <section class="row">
            <div id="edit-student" class="col-12 content scaffold-edit" role="main">
                ...
                <g:form resource="${this.student}" controller="${controllerName}" method="PUT">
                    ...
                    <fieldset class="form">
                        <f:field bean="student" property="firstName" class="form-control mb-3" required="true" />
                        <f:field bean="student" property="lastName" class="form-control mb-3" required="true" />
                        <f:field bean="student" property="email" class="form-control mb-3" required="true" />
                        <f:field bean="student" property="age" class="form-control mb-3" required="true" />
                    </fieldset>
